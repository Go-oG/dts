...
class OMaximalEdgeRing extends EdgeRing {
  OMaximalEdgeRing(super.start, super.geometryFactory);
  ...
  List<OMinimalEdgeRing> buildMinimalRings() {
    List<OMinimalEdgeRing> minEdgeRings = [];
    DirectedEdge? de = startDe;
    do {
      if (de!.getMinEdgeRing() == null) {
        final minEr = OMinimalEdgeRing(de, geometryFactory);
