...
class SnapTransformer extends GeometryTransformer {
  ...
  final List<Coordinate> _snapPts;
  final bool _isSelfSnap;

  SnapTransformer(this.snapTolerance, this._snapPts,
      [this._isSelfSnap = false]);

  @override
  CoordinateSequence? transformCoordinates(
      CoordinateSequence coords, Geometry? parent) {
    final srcPts = coords.toCoordinateArray();
    final newPts = snapLine(srcPts, _snapPts);
