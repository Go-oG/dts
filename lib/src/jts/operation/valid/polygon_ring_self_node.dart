...
class PolygonRingSelfNode {
    ...
    PolygonRingSelfNode(this. nodePt, this._e00, this._e01,this._e10, Coordinate e11);
    ...
    bool isExterior(bool isInteriorOnRight) {
        bool isInteriorSeg = PolygonNodeTopology.isInteriorSegment(nodePt, _e00, _e01, _e10);
