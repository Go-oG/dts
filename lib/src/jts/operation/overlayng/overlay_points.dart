...
final class OverlayPoints {
  ...
  void computeIntersection(Map<Coordinate, Point> map0, Map<Coordinate, Point> map1, List<Point> resultList) {
  ...
  void computeDifference(Map<Coordinate, Point> map0, Map<Coordinate, Point> map1, List<Point> resultList) {
    for (var entry in map0.entries) {
      if (!map1.containsKey(entry.key)) {
        resultList.add(copyPoint(entry.value));
      }
  ...
  void computeUnion(Map<Coordinate, Point> map0, Map<Coordinate, Point> map1, List<Point> resultList) {
  ...
  Point copyPoint(Point pt) {
    ...
    seq2.setOrdinate(0, CoordinateSequence.X, pm!.makePrecise2(seq.getX(0)));
    seq2.setOrdinate(0, CoordinateSequence.Y, pm!.makePrecise2(seq.getY(0)));
