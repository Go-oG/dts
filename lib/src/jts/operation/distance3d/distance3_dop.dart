...
class Distance3DOp {
  ...
  List<Coordinate> nearestPoints() {
    computeMinDistance();
    return [minDistanceLocation![0]!.getCoordinate(), minDistanceLocation![1]!.getCoordinate()];
  }

  List<GeometryLocation> nearestLocations() {
    computeMinDistance();
    return minDistanceLocation!.nonNulls.toList();
  }
  ...
  void computeMinDistance() {
    ...
    minDistanceLocation = List.filled(2, null);
